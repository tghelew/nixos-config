...
# Marker
marker_copied   = { fg = "${colors.dimmagenta}",  bg = "${colors.dimgreen}" }
marker_cut      = { fg = "${colors.dimred}",      bg = "${colors.dimred}" }
marker_marked   = { fg = "${colors.dimcyan}",     bg = "${colors.dimcyan}" }
marker_selected = { fg = "${colors.dimyellow}",   bg = "${colors.dimyellow}" }
...
# Count
count_copied   = { fg = "${colors.white}", bg = "${colors.green}" }
count_cut      = { fg = "${colors.green}", bg = "${colors.red}" }
count_selected = { fg = "${colors.white}", bg = "${colors.yellow}" }

# Border
border_symbol = "│"
border_style  = { fg = "${colors.grey}" }
...
# Permissions
perm_sep   = { fg = "${colors.dimgrey}" }
perm_type  = { fg = "${colors.green}" }
perm_read  = { fg = "${colors.yellow}" }
perm_write = { fg = "${colors.red}" }
perm_exec  = { fg = "${colors.cyan}" }
...
[which]
cols            = 3
mask            = { bg = "${colors.black}" }
cand            = { fg = "${colors.brightcyan}" }
rest            = { fg = "${colors.dimgrey}" }
desc            = { fg = "${colors.brightmagenta}" }
separator       = "  "
separator_style = { fg = "${colors.dimgrey}" }
...
rules = [
	...
	# Archives
	{ mime = "application/{zip,rar,7z*,tar,gzip,xz,zstd,bzip*,lzma,compress,archive,cpio,arj,xar,ms-cab*}", fg = "${colors.red}" },

	# Documents
	{ mime = "application/{pdf,doc,rtf}", fg = "${colors.cyan}" },

	# Empty files
	# { mime = "inode/empty", fg = "${colors.red}" },
	...
	# Dummy files
	{ name = "*", is = "dummy", bg = "${colors.red}" },
	{ name = "*/", is = "dummy", bg = "${colors.red}" },

	# Fallback
	# { name = "*", fg = "${colors.white}" },
	{ name = "*/", fg = "${colors.blue}" }
]
